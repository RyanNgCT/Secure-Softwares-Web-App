...
namespace ssd_assignment_team1_draft1.Migrations
{
    ...
    [Migration("20200805170854_AddApplicationRoles")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ssd_assignment_team1_draft1.Models.ApplicationRole", b =>
                {
            ...
            modelBuilder.Entity("ssd_assignment_team1_draft1.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("ssd_assignment_team1_draft1.Models.Review", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("ssd_assignment_team1_draft1.Models.ApplicationRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ssd_assignment_team1_draft1.Models.ApplicationUser", null)
                        .WithMany()
